...
import '../model/picker_profile.dart';

class PickerProfileService {
  int account_id;

  request() async {
    var response = await http.post(
      Uri.parse("https://pickerpacker.herokuapp.com/getPickerProfile"),
  ...
  parseJSON(var jsonResponse) async {
    ...
    return new Picker_Profile(json['name'], json['email'], json['phone'],
