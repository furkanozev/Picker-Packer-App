...
class PackerOrdersService {
  int account_id;

  request() async {
    var response = await http.post(
      Uri.parse("https://pickerpacker.herokuapp.com/getPackerOrder"),
  ...
  parseJSON(var jsonResponse) async {
    ...
    List<Packer_Order> listOrder = new List<Packer_Order>();

    for (var order in json) {
      listOrder.add(Packer_Order(
          order['item_amount'],
          order['order_id'],
          order['cart_barcode'],
          order['date'],
