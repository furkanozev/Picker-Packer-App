...
class Picker_Profile {
  ...
  bool contains(List<Picker_Profile> list) {
    for (var i in list) {
      if (i.name == this.name) {
        return true;
      }
  ...
  @override
  String toString() {
    return 'Picker_Profile{name: $name, email: $email, phone: $phone, age: $age, photo: $photo, is_active: $is_active}';
  }
}
