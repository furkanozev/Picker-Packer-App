...
import 'package:picker_packer/provider/packer_change_password_service.dart';
import '../flutter_flow/flutter_flow_theme.dart';
import 'package:flutter/material.dart';

class PackerChangePasswordWidget extends StatefulWidget {
  final UserLogin user;
  PackerChangePasswordWidget({
    Key key,
    @required this.user,
  }) : super(key: key);

  @override
  _PackerChangePasswordWidget createState() =>
      _PackerChangePasswordWidget(user);
}

class _PackerChangePasswordWidget extends State<PackerChangePasswordWidget> {
  UserLogin user;
  _PackerChangePasswordWidget(user) {
    this.user = user;
  }
  ...
  PackerChangePasswordService packerPasswordService =
      new PackerChangePasswordService();

  @override
  void initState() {
    super.initState();
    packerPasswordService.setAccountId(user.id);
  }

  changePassword() async {
    var res = await packerPasswordService.request();
    if (res == true) {
                          ...
                          onPressed: () {
                            ...
                            if (flag == 0) {
                              if (newPassword != validatePassword) {
                                ...
                                packerPasswordService.setChanges(
