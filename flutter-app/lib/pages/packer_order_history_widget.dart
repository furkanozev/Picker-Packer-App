...
import 'package:picker_packer/provider/packer_order_history_delete_all_service.dart';
import 'package:picker_packer/provider/packer_order_history_delete_service.dart';
import 'package:picker_packer/provider/packer_orders_history_service.dart';
import 'packer_order_history_details_widget.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:page_transition/page_transition.dart';

class PackerOrderHistoryWidget extends StatefulWidget {
  final UserLogin user;
  PackerOrderHistoryWidget({Key key, @required this.user}) : super(key: key);

  @override
  _PackerOrderHistoryWidgetState createState() =>
      _PackerOrderHistoryWidgetState(user);
}

class _PackerOrderHistoryWidgetState extends State<PackerOrderHistoryWidget>
  ...
  PackerOrdersHistoryService orderHistoryService =
      new PackerOrdersHistoryService();
  List<Packer_Order_History> orders = new List<Packer_Order_History>();

  PackerOrderHistoryDeleteService orderHistoryDeleteService =
      new PackerOrderHistoryDeleteService();
  PackerOrderHistoryDeleteAllService orderHistoryDeleteAllService =
      new PackerOrderHistoryDeleteAllService();
                            ...
                            onPressed: () async {
                              await Navigator.push(
                                  ...
                                  PageTransition(
                                      ...
                                      child: PackerOrderHistoryDetailsWidget(
                                          order: orders[index])));
                              updateOrderList();
                            },
                            shape: RoundedRectangleBorder(
