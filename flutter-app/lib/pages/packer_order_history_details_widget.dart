...
import 'package:picker_packer/model/packer_order_history_item.dart';
import 'package:picker_packer/provider/packer_order_history_items_service.dart';
import 'package:url_launcher/url_launcher.dart';

class PackerOrderHistoryDetailsWidget extends StatefulWidget {
  final Packer_Order_History order;
  const PackerOrderHistoryDetailsWidget({Key key, @required this.order})
      : super(key: key);

  @override
  _PackerOrderHistoryDetailsWidgetState createState() =>
      _PackerOrderHistoryDetailsWidgetState(order);
}

class _PackerOrderHistoryDetailsWidgetState
    extends State<PackerOrderHistoryDetailsWidget>
    with SingleTickerProviderStateMixin {
  Packer_Order_History order;
  _PackerOrderHistoryDetailsWidgetState(order) {
    this.order = order;
  }
  final scaffoldKey = GlobalKey<ScaffoldState>();

  PackerOrderHistoryItemsService orderHistoryItemsService =
      new PackerOrderHistoryItemsService();
  List<Packer_Order_History_Item> order_items =
      new List<Packer_Order_History_Item>();
