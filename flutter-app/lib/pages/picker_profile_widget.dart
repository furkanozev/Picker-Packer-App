...
import 'package:picker_packer/pages/picker_change_password_widget.dart';
import 'package:picker_packer/pages/picker_edit_profile_widget.dart';
import 'package:picker_packer/provider/picker_profile_service.dart';
import 'package:picker_packer/provider/picker_set_active.dart';
import '../flutter_flow/flutter_flow_theme.dart';
import 'package:flutter/material.dart';
import 'login_widget.dart';

class PickerProfileWidget extends StatefulWidget {
  final UserLogin user;
  PickerProfileWidget({Key key, @required this.user}) : super(key: key);

  @override
  _PickerProfileWidgetState createState() => _PickerProfileWidgetState(user);
}

class _PickerProfileWidgetState extends State<PickerProfileWidget>
    with SingleTickerProviderStateMixin {
  UserLogin user;
  _PickerProfileWidgetState(user) {
    this.user = user;
  }
  ...
  PickerProfileService pickerProfileService = new PickerProfileService();
  Picker_Profile profile;

  PickerSetActive setPickerActiveService = new PickerSetActive();

  @override
  void initState() {
    super.initState();
    pickerProfileService.setAccountId(user.id);
    setPickerActiveService.setAccountId(user.id);
    updateProfile();
  }

  updateProfile() async {
    profile = await pickerProfileService.request();
    setState(() {});
  }

  setPickerActive() async {
    var res = await setPickerActiveService.request();
    if (res == true) {
                          ...
                          onTap: () async {
                            await Navigator.push(
                              ...
                              PageTransition(
                                  type: PageTransitionType.rightToLeft,
                                  child:
                                      PickerChangePasswordWidget(user: user)),
                            );
                            updateProfile();
                          },
                          child: Row(
